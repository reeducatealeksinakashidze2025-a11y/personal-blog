...
//   addReply(parentCommentId: string, replyText: string) {
...
//       text: replyText
//     }).subscribe(res => {
//       // პოულობს შესაბამის parent comment-ს და უჯრის reply-ს
//       const parent = this.findCommentById(this.comments, parentCommentId);
//       if (parent) {
//         parent.replies = parent.replies || [];
//         parent.replies.push(res.value);
//       }
//     });
//   }

//   findCommentById(comments: any[], id: string): any {
...
//   this.commentService
//     .addReply(this.blog._id, parentId, text)
//     .subscribe({
//       next: () => this.loadComments(), // თავიდან ჩატვირთვა
